...
$formName = 'esol_importexportexcel_settings';
...
if($USER->IsAdmin())
{
	...
	<tr>
		...
		<td>
			<input type="hidden" name="SETTINGS[NOTIFY_BREAK_IMPORT_NC]" value="N">
			<input type="checkbox" name="SETTINGS[NOTIFY_BREAK_IMPORT_NC]" value="Y" <?if(COption::GetOptionString($moduleId, 'NOTIFY_BREAK_IMPORT_NC', 'N')=='Y') echo 'checked';?>>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			&nbsp; <a href="https://accounts.google.com/o/oauth2/auth?client_id=685892932415-87toodq5o9e4vq8pqeh1es86vlcf3oi7.apps.googleusercontent.com&redirect_uri=https://esolutions.su/marketplace/oauth.php&access_type=offline&response_type=code&scope=https://www.googleapis.com/auth/drive.readonly https://www.googleapis.com/auth/userinfo.email" target="_blank"><? echo Loc::getMessage('KDA_IE_OPTIONS_GOOGLE_DRIVE_APIKEY_GET'); ?></a>
		</td>
	</tr>
