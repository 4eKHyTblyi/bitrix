...
class CKDAEEFieldList {
	...
	public function ShowSelectFilterFields($IBLOCK_ID, $fname)
	{
		$arGroups = $this->GetFiltrableFields($IBLOCK_ID);
	...
	public function GetHigloadBlockFields($HIGHLOADBLOCK_ID)
	{
		if(!isset($this->hlblFields[$HIGHLOADBLOCK_ID]))
		{
			...
			$arHLFields = array('ID' => array('FIELD_NAME'=>'ID', 'NAME_LANG'=>'ID', 'sortable'=>'Y'));
