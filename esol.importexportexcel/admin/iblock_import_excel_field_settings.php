	...
	<table width="100%">
		...
		<?if($bPropList){?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[PROPLIST_VALDESC_SEP]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="text" name="<?=$fName?>" value="<?=htmlspecialcharsbx($val)?>" size="3">
			...
			<tr class="subparams" <?if(!$createNewProps){echo 'style="display: none;"';}?>>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[PROPLIST_NEWPROP_MULTIPLE]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
			...
			<tr class="subparams" <?if(!$createNewProps){echo 'style="display: none;"';}?>>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[PROPLIST_NEWPROP_SMART_FILTER]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
			...
			<tr class="subparams" <?if(!$createNewProps){echo 'style="display: none;"';}?>>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[PROPLIST_NEWPROP_DISPLAY_EXPANDED]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
			...
			?>
				<tr class="subparams" <?if(!$createNewProps){echo 'style="display: none;"';}?>>
					...
					<td class="adm-detail-content-cell-r">
						<?
						$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[PROPLIST_NEWPROP_FEATURE_'.htmlspecialcharsbx($arFeature['MODULE_ID'].':'.$arFeature['FEATURE_ID']).']';
						$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
						eval('$val = $P'.$fNameEval.';');
						?>
						<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
		...
		<?if($bStoreList){?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[STORELIST_STORES_SEP]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[STORELIST_STOREVALS_SEP]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="text" name="<?=$fName?>" value="<?=htmlspecialcharsbx($val)?>" size="3" placeholder=":">
		...
		<?if($bSectPropList){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[SECTPROPS_SMART_FILTER]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<select name="<?=$fName?>">
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[SECTPROPS_DISPLAY_EXPANDED]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<select name="<?=$fName?>">
		...
		<?if($bIblockElement || $bProductGift){?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[REL_ELEMENT_ALLOW_ORIG]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					$val = '';
		...
		<?if($bPropTypeList){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[PROPLIST_NOT_CREATE_VALS]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
		...
		<?if($bVideo){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[VIDEO_WIDTH]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[VIDEO_HEIGHT]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
		...
		<?if($bIblockElementSet){?>
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[SET_ADD_PRODUCTS_TO_EXISTS]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
		  ...
		  <?if($bIblockElementSetType=='SET2'){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[CHECK_PRODUCTS_EXISTS]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
		...
		<tr>
			<td class="kda-ie-settings-margin-container" colspan="2" id="kda-ie-conv-wrap0">
				<?
		...
		if($bPicture)
		{
			...
			<tr>
				<td class="adm-detail-content-cell-r" colspan="2" style="padding-left: 50px;">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[EXCLUDE_DETAIL_PICTURE]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
			...
			<tr>
				...
				<?if($bElemPicture){?>
						<?
						$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[INCLUDE_PICTURE_PROCESSING]';
						$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
						eval('$val = $P'.$fNameEval.';');
		...
		<?if($bPicture){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[SAVE_ORIGINAL_PATH]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
		...
		<?if($isOffer /*$bCanUseForSKUGenerate*/){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[BIND_TO_GENERATED_SKU]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="checkbox" name="<?=$fName?>" value="Y" <?=($val=='Y' ? 'checked' : '')?>>
		...
		<?if($bPicture){?>
			<tr>
				...
				<td class="adm-detail-content-cell-r" style="min-width: 30%;">
					<?
					$fName = 'EXTRA'.str_replace('[FIELDS_LIST]', '', $fieldName).'[FILE_HEADERS]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
					eval('$val = $P'.$fNameEval.';');
					?>
		...
		<tr>
			<td class="kda-ie-settings-margin-container" colspan="2" id="kda-ie-conv-wrap1">
				<?
				...
				foreach($arVals as $k=>$v)
				{
					...
					$cellsOptions .= '<option value="DUPLICATE"'.($v['CELL']=='DUPLICATE' ? ' selected' : '').'>'.GetMessage("KDA_IE_SETTINGS_CONVERSION_CELL_DUPLICATE").'</option>';
